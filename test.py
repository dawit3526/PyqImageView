...
I have tested this programme in Linux  environment which I found scrolling stays 
in the same focus of view, as your mouse is pointing over, ctr+click for panning also works good, 
or shift-dragging to create a selectable region it's zooming factor looks like big within the second click 
